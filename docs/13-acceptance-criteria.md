...
- [x] R1 BKAI+PyVi dense retrieval has a separate offline index contract, focused unit checks, and a source-ID evaluator; its live dev report remains required before a quality claim.
